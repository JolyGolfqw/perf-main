...
export function WhatsAppIcon() {
  return (
    <svg
      className="footer-social-icon social-icon social-icon--wide"
...
export function InstagramIcon() {
  ...
  return (
    <svg
      className="footer-social-icon social-icon social-icon--compact"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <defs>
          <radialGradient id={gradientOneId} cx="217.76" cy="3290.99" r="4271.92" gradientUnits="userSpaceOnUse">
            <stop offset=".09" stopColor="#fa8f21" />
            <stop offset=".78" stopColor="#d82d7e" />
          </radialGradient>
          <radialGradient id={gradientTwoId} cx="2330.61" cy="3182.95" r="3759.33" gradientUnits="userSpaceOnUse">
